    ...
    <div className="min-h-screen flex items-center justify-center bg-surface px-4">
      <div className="max-w-md w-full rounded-3xl border border-outline p-10 bg-surface-container-high shadow-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-on-surface mb-2">Faculty Sign Up</h1>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          <div>
            <label htmlFor="department" className="block text-sm font-medium text-on-surface mb-2">
              Department
            </label>
            <input
              id="department"
